...
def post_detail_view(request,year,month,day,slug):
    ...
    if request.method=='POST':
        ...
        if form.is_valid():
            ...
            form = CommentForm()
    return render(request,'blog/post_detail.html',{'post':post,'form':form,'comment':comments,'csubmit':csubmit})
...
def mail_send_view(request,id):
    ...
    if request.method=='POST':
        ...
        if form.is_valid():
            ...
            send_mail(subject,message,'djangodevelopersmtp@gmail.com',[cd['to']])
            sent = True
        else:
            form = EmailSendForm()
